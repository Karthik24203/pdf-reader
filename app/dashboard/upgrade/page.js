...
function UpgradePlan() {
  ...
  const onPaymentSuccess = async () => {
    const result = await axios.put("/api/update-plan", {
  ...
  return (
    <div>
      ...
      <p>Update your plan to upload multiple components</p>

      <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-center md:gap-8">
          <div className="rounded-2xl border p-6 shadow-sm ring-1 sm:order-last sm:px-8 lg:p-12">
            ...
            <div className=" mt-3 rounded-md">
              {/* <Button onClick={() => onPaymentSuccess()}>click</Button> */}
              <PayPalButtons
